    ...
    <AppShell>
      <section className="space-y-8">
        <div>
          ...
          <p className="mt-4 max-w-2xl text-base leading-7 text-black">Bring your goals and experience together so every part of CareerForge stays relevant to you.</p>
        </div>
